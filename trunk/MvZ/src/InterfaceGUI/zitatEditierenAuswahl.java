 ...
 * @author Tobias
 */
public class zitatEditierenAuswahl {
...
JLabel listelabel;
    ...
    public static void main(String[] args) {
        zitatEditierenAuswahl gui = new zitatEditierenAuswahl();
        gui.zitatEditieren();
        }


public void zitatEditieren(){

frame = new JFrame("Zitat editieren");
...
listelabel = new JLabel("Bitte wählen Sie ein gewünschtes Zitat:");
...
zitat = new JComboBox();
zitat.addItem("Zitat 1");
Dimension groesseSammelwerk = new Dimension(300, 25);
zitat.setPreferredSize(groesseSammelwerk);
constraints.gridwidth = GridBagConstraints.REMAINDER;
constraints.weightx = 1;
constraints.fill = GridBagConstraints.NONE;
editierenPanel.add(zitat, constraints);
