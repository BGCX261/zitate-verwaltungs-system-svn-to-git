 ...
 * @author Ben
 */
public class zitatAktualisieren {
...
public static void main(String[] args) {
        zitatAktualisieren gui = new zitatAktualisieren();
        gui.zitatAktualisieren();
        }


public void zitatAktualisieren(){

frame = new JFrame ("Zitat aktualisieren");
...
constraints.weighty = 0;
constraints.fill = GridBagConstraints.NONE;
zitatAnlegenPanel.add(aktualisieren, constraints);
...
class aktualisierenListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent event){
      ...
      int antwort = JOptionPane.showConfirmDialog(frame, "Wollen Sie dieses Zitat aktualisieren?",
      "", JOptionPane.YES_NO_OPTION);
      if (antwort == JOptionPane.YES_OPTION){

        JOptionPane.showMessageDialog(frame,"Zitat aktualisiert!");
