...
JComboBox boxanlegen;
    ...
    public static void main(String[] args) {
        zitatLöschen gui = new zitatLöschen();
        gui.zitatLöschen();
        }


public void zitatLöschen(){



frame = new JFrame("Zitat löschen");
...
listelabel = new JLabel("Bitte wählen Sie ein Zitat:");
...
class löschenListener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent event){
      ...
      int antwort = JOptionPane.showConfirmDialog(frame, "Wollen Sie dieses Zitat wirklich löschen?",
      "", JOptionPane.YES_NO_OPTION);
      if (antwort == JOptionPane.YES_OPTION) {

            JOptionPane.showMessageDialog(frame,"Zitat gelöscht!");
